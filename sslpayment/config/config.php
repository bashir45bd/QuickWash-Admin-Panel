...
if (!defined('PROJECT_PATH')) {
    define('PROJECT_PATH', 'http://192.168.0.109/Laundry/sslpayment'); // replace this value with your project path
}
...
if (!defined('STORE_ID')) {
    define('STORE_ID', 'amarl6887c70cba474'); // your store id. For sandbox, register at https://developer.sslcommerz.com/registration/
}

if (!defined('STORE_PASSWORD')) {
    define('STORE_PASSWORD', 'amarl6887c70cba474@ssl'); // your store password.
}
