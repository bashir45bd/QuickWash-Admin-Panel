...
# OPTIONAL PARAMETERS
$post_data['value_a'] = $_POST['promo_code'] ?? '';
$post_data['value_b'] = $_POST['pickup_date'] ?? '';
$post_data['value_c'] = $_POST['delivery_date'] ?? '';
$post_data['value_d'] = $_POST['user_id']; // user id
